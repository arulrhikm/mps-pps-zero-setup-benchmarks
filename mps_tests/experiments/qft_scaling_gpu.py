#!/usr/bin/env python3
"""
MPS QFT scaling (GPU) — high-qubit QFT runtime vs n.
...
Usage:
    python experiments/qft_scaling_gpu.py
    # Default output: data/qft_scaling_gpu.jsonl
"""
...
DEFAULT_OUTPUT = os.path.join(DATA_DIR, "qft_scaling_gpu.jsonl")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MPS GPU QFT scaling")
