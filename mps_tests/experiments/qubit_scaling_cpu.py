#!/usr/bin/env python3
"""
MPS Qubit Scaling (CPU)
=====================================
Runtime vs number of qubits at fixed depth and bond dimension.

Config: n ∈ {16, 20, ..., 96}  |  depth=16  |  χ=256  |  shots=1000
Device: mps.cpu

Usage:
    python experiments/qubit_scaling_cpu.py
    # Default output: data/qubit_scaling_cpu.jsonl
"""
...
DEFAULT_OUTPUT = os.path.join(DATA_DIR, "qubit_scaling_cpu.jsonl")
...
def run_benchmark(output_file: str, max_in_flight: int, poll_interval_s: float):
    ...
    print(f"\n{'='*60}")
    print(f"MPS CPU Qubit Scaling Benchmark")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MPS CPU Qubit Scaling")
