#!/usr/bin/env python3
"""
MPS shots scaling (GPU) — fixed QV circuit, sweep shots.
...
Usage:
    python experiments/shots_scaling_gpu.py
    # Default output: data/shots_scaling_gpu.jsonl
"""
...
DEFAULT_OUTPUT = os.path.join(DATA_DIR, "shots_scaling_gpu.jsonl")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MPS GPU shots scaling")
