...
Usage:
    python experiments/depth_scaling_gpu.py
    # Default output: data/depth_scaling_gpu.jsonl
"""
...
DEFAULT_OUTPUT = os.path.join(DATA_DIR, "depth_scaling_gpu256.jsonl")
...
def run_benchmark(output_file: str):
    ...
    print(f"\n{'='*60}")
    print(f"MPS GPU Depth Scaling Benchmark")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MPS GPU Depth Scaling")
