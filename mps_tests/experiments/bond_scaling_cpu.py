#!/usr/bin/env python3
"""
MPS Bond Dimension Scaling (CPU)
=============================================
Runtime vs bond dimension (χ) at fixed qubits and depth.

Config: n=40  |  depth=10  |  χ ∈ {4,8,...,120, 128,160,...,1024}  |  shots=1000
Device: mps.cpu

Usage:
    python experiments/bond_scaling_cpu.py
    # Default output: data/bond_scaling_cpu.jsonl
"""
...
DEFAULT_OUTPUT = os.path.join(DATA_DIR, "bond_scaling_cpu.jsonl")

NUM_QUBITS = 40
DEPTH = 10
BOND_DIMS = [32, 64, 128, 256, 384, 512, 768, 1024]
NUM_TRIALS = 5
SHOTS = 1
...
def run_benchmark(
    ...
    print(f"\n{'='*60}")
    print(f"MPS CPU Bond Dimension Scaling Benchmark")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MPS CPU Bond Dimension Scaling")
