"""
experiment6_qft_cpu.py
======================
Demo experiment: Quantum Fourier Transform (QFT) scaling on MPS CPU.

Goal:
  Demonstrate that BlueQubit's MPS CPU simulator can execute QFT circuits
  at high qubit counts (up to 96 qubits) – well beyond what a statevector
  simulator could handle (practical limit ~30 qubits).
...
Output:
  data/cpu/experiment6_qft_cpu.jsonl
"""
...
OUTPUT_FILE = os.path.join(
    ...
    "..", "..", "data", "cpu",
    "experiment6_qft_scaling_cpu.jsonl"
)
...
if os.path.exists(OUTPUT_FILE):
    ...
    with open(OUTPUT_FILE, "w") as f:
        f.write("# Experiment 6: QFT high-qubit-count scaling demo (MPS CPU)\n")
...
print(f"\nExperiment 6 – QFT scaling demo on MPS CPU")
print(f"{'─'*60}")
    ...
    for trial in range(NUM_TRIALS):
        ...
        try:
            ...
            record = {
                ...
                "source_file":         "cpu/experiment6_qft_scaling_cpu.jsonl",
            }
