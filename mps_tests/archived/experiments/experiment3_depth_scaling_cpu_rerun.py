"""
experiment3_depth_scaling_cpu_rerun.py
======================================
Add trials 1-4 for Experiment 3 (Depth Scaling) on MPS CPU.
...
OUTPUT_FILE = os.path.join(
    ...
    "..", "..", "data", "cpu",
    "experiment3_depth_scaling_cpu.jsonl",
)
...
print(f"\n{'='*60}")
print(f"Experiment 3 CPU rerun complete!")
