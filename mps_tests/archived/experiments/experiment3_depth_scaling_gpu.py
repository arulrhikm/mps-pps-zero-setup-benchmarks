...
# Experiment 3: Depth Scaling (GPU)
# Goal: Verify that runtime scales linearly with depth (runtime/gate is flat)
# Configuration: Qubits [72, 80, 88, 96], Depth [4, 8, 12, 16, 24, 32, 40, 48, 56, 64], Bond=256 (fixed)
# Single circuit per configuration (no averaging)

output_file = 'experiment3_depth_scaling_gpu.jsonl'
num_trials = 1
...
print(f'Experiment 3 (GPU) complete! Results written to {output_file}')
