"""
experiment2_bond_scaling_cpu_rerun.py
=====================================
Bond Dimension Scaling (Section 5.1 & 5.2) on MPS CPU.
...
Config: n=40 | d=16 | shots=1 | bond_dims={32,64,128,256,512,768,1024} | 5 trials
"""
...
OUTPUT_FILE = os.path.join(
    ...
    "..", "..", "data", "cpu",
    "experiment2_bond_scaling_cpu.jsonl",
)
...
DEPTH = 16
SHOTS = 1
BOND_DIMS = [32, 64, 128, 256, 512, 768, 1024]
...
print(f"\n{'='*60}")
print(f"Experiment 2 CPU rerun complete!")
