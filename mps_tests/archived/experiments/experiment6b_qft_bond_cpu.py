...
Output:
  data/cpu/experiment6b_qft_bond_cpu.jsonl
"""
...
OUTPUT_FILE = os.path.join(
    ...
    "..", "..", "data", "cpu",
    "experiment6b_qft_bond_cpu.jsonl"
)
...
if os.path.exists(OUTPUT_FILE):
    ...
    with open(OUTPUT_FILE, "w") as f:
        f.write("# Experiment 6b: QFT bond-dimension sweep (MPS CPU)\n")
...
print(f"\nExperiment 6b – QFT bond-dimension sweep on MPS CPU")
print(f"{'─'*55}")
    ...
    for trial in range(NUM_TRIALS):
        ...
        try:
            ...
            record = {
                ...
                "source_file":         "cpu/experiment6b_qft_bond_cpu.jsonl",
            }
...
print("\nExperiment 6b CPU (QFT bond sweep) complete.")
