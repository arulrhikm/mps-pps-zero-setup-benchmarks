...
# Experiment 2: Bond Dimension Scaling - Extended to 1024
# Goal: Scale bond dimension from 4 to 1024 at fixed 40 qubits
# Configuration: Qubits=40 (fixed), Depth=64 (fixed), Bond=[4-120 by 4, then 128-1024 by 32]
...
bond_dimensions = list(range(4, 124, 4)) + list(range(128, 1025, 32))
